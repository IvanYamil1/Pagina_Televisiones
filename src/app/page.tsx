...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white">
      ...
      <section id="contacto" className="min-h-screen px-4 sm:px-6 py-12 sm:py-20 bg-[#030712] relative overflow-hidden flex items-center">
        {/* Background Effects */}
        ...
        <div ref={contactoAnim.ref} className="max-w-6xl mx-auto relative w-full">
          {/* Header */}
          <div className={`text-center mb-10 sm:mb-16 ${contactoAnim.isVisible ? 'animate-reveal-up' : 'opacity-0'}`}>
            <p className={`text-[10px] tracking-[0.4em] text-emerald-400/70 mb-4 sm:mb-6 ${contactoAnim.isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '200ms', animationFillMode: 'both' }}>CONTACTO</p>
            <div className="overflow-hidden">
              <h2 className={`font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight ${contactoAnim.isVisible ? 'animate-clip-reveal' : 'opacity-0'}`} style={{ animationDelay: '450ms', animationFillMode: 'both' }}>
                Estamos aquí<br />
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className={`${contactoAnim.isVisible ? 'animate-reveal-left' : 'opacity-0'}`} style={{ animationDelay: '700ms', animationFillMode: 'both' }}>
              ...
              <div className="space-y-3 sm:space-y-4">
                {/* Location Card */}
                <div className={`group relative p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/20 hover:bg-white/[0.04] transition-all duration-500 ${contactoAnim.isVisible ? 'animate-stagger-up' : 'opacity-0'}`} style={{ animationDelay: '900ms', animationFillMode: 'both' }}>
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0 group-hover:bg-emerald-500/20 transition-colors">
                    ...
                    <div>
                      <p className="text-[9px] sm:text-[10px] tracking-[0.2em] text-white/30 mb-1 sm:mb-2">UBICACIÓN</p>
                      <h3 className="font-serif text-lg sm:text-xl md:text-2xl font-light mb-0.5 sm:mb-1">Guadalajara Centro</h3>
                      <p className="text-white/40 text-xs sm:text-sm">Jalisco, México</p>
                    </div>
                  </div>
                </div>

                {/* Hours Card */}
                <div className={`group relative p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/20 hover:bg-white/[0.04] transition-all duration-500 ${contactoAnim.isVisible ? 'animate-stagger-up' : 'opacity-0'}`} style={{ animationDelay: '1100ms', animationFillMode: 'both' }}>
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0 group-hover:bg-emerald-500/20 transition-colors">
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      <p className="text-[9px] sm:text-[10px] tracking-[0.2em] text-white/30 mb-1 sm:mb-2">HORARIO</p>
                ...
                {/* Contact Buttons */}
                <div className={`grid grid-cols-2 gap-2 sm:gap-4 pt-2 ${contactoAnim.isVisible ? 'animate-stagger-up' : 'opacity-0'}`} style={{ animationDelay: '1300ms', animationFillMode: 'both' }}>
                  <a
                    href="tel:+521234567890"
                    className="group relative p-3 sm:p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all duration-500 text-center"
                  >
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-blue-500/10 flex items-center justify-center mx-auto mb-2 sm:mb-3 group-hover:bg-blue-500/20 group-hover:scale-110 transition-all">
                    ...
                    <p className="text-[8px] sm:text-[9px] tracking-[0.2em] text-white/30 mb-0.5 sm:mb-1">TELÉFONO</p>
                    <span className="font-serif text-sm sm:text-lg text-white/80 group-hover:text-white transition-colors">123 456 7890</span>
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative p-3 sm:p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/30 hover:bg-emerald-500/5 transition-all duration-500 text-center"
                  >
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-emerald-500/10 flex items-center justify-center mx-auto mb-2 sm:mb-3 group-hover:bg-emerald-500/20 group-hover:scale-110 transition-all">
                      <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-400" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                      </svg>
                    </div>
                    <p className="text-[8px] sm:text-[9px] tracking-[0.2em] text-white/30 mb-0.5 sm:mb-1">WHATSAPP</p>
                    <span className="font-serif text-sm sm:text-lg text-white/80 group-hover:text-white transition-colors">123 456 7890</span>
                  </a>
                </div>

                {/* Map */}
                <div className={`mt-4 rounded-2xl overflow-hidden border border-white/5 ${contactoAnim.isVisible ? 'animate-zoom-reveal' : 'opacity-0'}`} style={{ animationDelay: '1500ms', animationFillMode: 'both' }}>
                  <div className="relative">
                    <iframe
            ...
            <div className={`${contactoAnim.isVisible ? 'animate-reveal-right' : 'opacity-0'}`} style={{ animationDelay: '900ms', animationFillMode: 'both' }}>
              <div className="relative p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/[0.02] border border-white/5 backdrop-blur-sm">
                {/* Form glow effect */}
                ...
                <form className="relative space-y-4 sm:space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
                    <div className="group">
                      <label className="block text-[9px] sm:text-[10px] tracking-[0.2em] text-white/40 mb-2 sm:mb-3 group-focus-within:text-emerald-400/70 transition-colors">NOMBRE</label>
                      <input
                        type="text"
                        placeholder="Tu nombre"
                        className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base text-white placeholder-white/20 focus:outline-none focus:border-emerald-500/50 focus:bg-white/[0.05] transition-all"
                      />
                    </div>
                    <div className="group">
                      <label className="block text-[9px] sm:text-[10px] tracking-[0.2em] text-white/40 mb-2 sm:mb-3 group-focus-within:text-emerald-400/70 transition-colors">TELÉFONO</label>
                      <input
                        type="tel"
                  ...
                  <div>
                    <label className="block text-[9px] sm:text-[10px] tracking-[0.2em] text-white/40 mb-2 sm:mb-3">SERVICIO</label>
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {['Reparación', 'Tarjeta', 'Panel', 'Otro'].map((option) => (
                        <label key={option} className="relative cursor-pointer">
                          ...
                          <div className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-white/10 bg-white/[0.02] text-white/40 text-[10px] sm:text-xs tracking-[0.1em]
                  ...
                  <div className="group">
                    <label className="block text-[9px] sm:text-[10px] tracking-[0.2em] text-white/40 mb-2 sm:mb-3 group-focus-within:text-emerald-400/70 transition-colors">MENSAJE</label>
                    <textarea
                      rows={3}
                      placeholder="Describe el problema: marca, modelo, síntomas..."
                      className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base text-white placeholder-white/20 focus:outline-none focus:border-emerald-500/50 focus:bg-white/[0.05] transition-all resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="group w-full relative overflow-hidden rounded-lg bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 sm:px-8 py-3 sm:py-4 text-[10px] sm:text-xs tracking-[0.2em] text-white font-medium
